[![CI Workflow](https://github.com/MohamedAlyLoutfy/automation-exercise/actions/workflows/ci.yml/badge.svg)](https://github.com/MohamedAlyLoutfy/automation-exercise/actions/workflows/ci.yml)
# Automation Exercise
